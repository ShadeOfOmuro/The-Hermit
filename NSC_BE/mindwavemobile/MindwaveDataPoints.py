...
class UnknownDataPoint(DataPoint):
    ...
    def __str__(self):
        retMsgString = "UOV:{}".format(self.unknownPoint)
        return retMsgString
...
class PoorSignalLevelDataPoint(DataPoint):
    ...
    def __str__(self):
        poorSignalLevelString = "PSL:" + str(self.amountOfNoise)
...
class AttentionDataPoint(DataPoint):
    ...
    def __str__(self):
        return "AL:" + str(self.attentionValue)
...
class MeditationDataPoint(DataPoint):
    ...
    def __str__(self):
        return "ML:" + str(self.meditationValue)
...
class EEGPowersDataPoint(DataPoint):
    ...
    def __str__(self):
        return "D:{self.delta}:T:{self.theta}:LA:{self.lowAlpha}:HA:{self.highAlpha}:LB:{self.lowBeta}:HB:{self.highBeta}:LG:{self.lowGamma}:MG:{self.midGamma}".format(self = self)
